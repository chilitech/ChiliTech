...
public class ToolBarUtil {
    ...
    public static void setStatusBarFits(Toolbar toolbar) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            if (toolbar.getLayoutParams() instanceof AppBarLayout.LayoutParams) {
                ...
                hideNavigationBar((AppCompatActivity) toolbar.getContext());
            }
        }
    }
     ...
     * @param activity
     */
    public static void setStatusBarLight(AppCompatActivity activity) {
     ...
     * @param activity
     */
    public static void setStatusBarDefault(AppCompatActivity activity) {
     ...
     * @param isImmersive
     */
    public static void setStatusBarImmersive(AppCompatActivity activity, boolean isImmersive) {
     ...
     * @param hasFocus
     */
    public static void setStatusBarImmersiveWindowFocusChanged(AppCompatActivity activity, boolean hasFocus) {
