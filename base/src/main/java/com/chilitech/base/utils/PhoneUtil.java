...
public class PhoneUtil {
     ...
     */
    public static void toTakePhoto(int requestCode, AppCompatActivity activity, String fileName) {
     ...
     * @param activity    上下文
     */
    public static void toTakePicture(int requestCode, AppCompatActivity activity) {
