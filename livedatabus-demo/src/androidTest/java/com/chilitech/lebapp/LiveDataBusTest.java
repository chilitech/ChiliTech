...
import com.chilitech.lebapp.activity.TestActivity;
import com.chilitech.lebapp.helper.LiveEventBusTestHelper;
import com.chilitech.lebapp.obj.GoodBean;
import com.chilitech.lebapp.obj.SerializableObject;
import com.chilitech.lebapp.wrapper.Wrapper;
...
public class LiveDataBusTest {
    ...
    public void testSendMsgBeforeObserve() throws Exception {
        ...
        rule.getActivity().runOnUiThread(new Runnable() {
            @Override
            public void run() {
                LiveDataBus.get(randomKey, String.class).post("msg_set_before");
                LiveDataBus
    ...
    public void testSendMsgBeforeAndAfterObserve() throws Exception {
        ...
        rule.getActivity().runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                LiveDataBus.get(randomKey, String.class).post("msg_set_after");
            }
        });
        Thread.sleep(500);
        Assert.assertEquals(rule.getActivity().strResult, "msg_set_after");
    ...
    public void testSendWrongTypeMsg() throws Exception {
        ...
        rule.getActivity().runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                LiveDataBus.get(key, Integer.class).post(10);
    ...
    public void testRemoveObserve() throws Exception {
        Observable<String> observe = LiveDataBus.get("key_test_remove_observe", String.class);
    ...
    public void testAutoRemoveObserve() throws Exception {
        Observable<String> observe = LiveDataBus.get("key_test_auto_remove_observe", String.class);
        Map map = (Map) LiveEventBusTestHelper.getLiveEventField("observerMap", observe);
        LiveData liveData = (LiveData) LiveEventBusTestHelper.getLiveEventField("liveData", observe);
    ...
    public void testClearBusOnRemove() throws Exception {
        LiveEventBusTestHelper.clearConfigs();
        LiveDataBus.config().autoClear(true);
    ...
    @Test
    public void testClearBusOnRemoveAutoSingle() throws Exception {
        LiveEventBusTestHelper.clearConfigs();
        LiveDataBus.config().autoClear(false);
        final String key = "test_clear_bus_on_remove_auto_single";
        LiveDataBus
                .config(key)
                .autoClear(true);
        int count = LiveEventBusTestHelper.getLiveEventBusCount();
    ...
    public void testClearBusOnRemoveAutoAndAlwaysActiveFalse() throws Exception {
        LiveEventBusTestHelper.clearConfigs();
        LiveDataBus.config().autoClear(true);
        LiveDataBus.config().lifecycleObserverAlwaysActive(false);
    ...
    @Test
    public void testClearBusOnRemoveAutoAndAlwaysActiveFalseSingle() throws Exception {
        LiveEventBusTestHelper.clearConfigs();
        LiveDataBus.config().autoClear(false);
        LiveDataBus.config().lifecycleObserverAlwaysActive(true);
        final String key = "test_clear_bus_on_remove_auto_aaf_single";
        LiveDataBus
                .config(key)
                .autoClear(true);
        int count = LiveEventBusTestHelper.getLiveEventBusCount();
    ...
    @Test
    public void testClearBusOnRemoveAutoAndAlwaysActiveFalseSingle1() throws Exception {
        LiveEventBusTestHelper.clearConfigs();
        LiveDataBus.config().autoClear(true);
        LiveDataBus.config().lifecycleObserverAlwaysActive(true);
        final String key = "test_clear_bus_on_remove_auto_aaf_single_1";
        LiveDataBus
                .config(key)
                .autoClear(false);
        int count = LiveEventBusTestHelper.getLiveEventBusCount();
        ...
        Thread.sleep(1000);
        Log.d("LiveEventBus", "bus.size final: " + LiveEventBusTestHelper.getLiveEventBusCount());
        Assert.assertEquals(LiveEventBusTestHelper.getLiveEventBusCount(), 1);
    }
