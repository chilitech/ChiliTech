package com.chilitech.demo_rxjava2.utils;

import android.util.Log;

import com.androidnetworking.error.ANError;
import com.chilitech.demo_rxjava2.model.ApiUser;
import com.chilitech.demo_rxjava2.model.User;
...
public class Utils {
    ...
    public static List<ApiUser> getApiUserList() {
        ...
        apiUserOne.firstname = "王";
        apiUserOne.lastname = "小琦";
        apiUserList.add(apiUserOne);

        ApiUser apiUserTwo = new ApiUser();
        apiUserTwo.firstname = "王";
        apiUserTwo.lastname = "颀栎";
        apiUserList.add(apiUserTwo);

        ApiUser apiUserThree = new ApiUser();
        apiUserThree.firstname = "马";
        apiUserThree.lastname = "良芹";
